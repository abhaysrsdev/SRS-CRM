          ...
          <AnimatePresence>
            {isInsightsPanelOpen && (
              <motion.div
                ...
                className="fixed right-0 top-0 bottom-0 w-96 bg-white/90 backdrop-blur-xl shadow-[-10px_0_30px_-10px_rgba(0,0,0,0.1)] border-l border-slate-200 z-50 p-6 flex flex-col"
              >
